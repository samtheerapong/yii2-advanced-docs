...
('202308-???', 48, 1, 1692778263),
('5bce8a536749f4b5ebc03a256521426b', 24, 1, 1690343279),
('6b69808add184662b21eb56e9fb9f805', 3, 1, 1692758290),
('cb6105f484ffd5639fbc25fa3de20634', 46, 1, 1692778263),
('NCR-2308/?', 4, 1, 1692758290),
('P202308-???', 62, 1, 1692783146);
...
--
-- Table structure for table `dc_requests`
--

CREATE TABLE `dc_requests` (
  `id` int(11) NOT NULL,
  `types_id` int(11) DEFAULT NULL COMMENT 'ประเภทการร้องขอ',
  `type_details` text COMMENT 'รายละเอียดการร้องขอ',
  `status_id` int(11) DEFAULT NULL COMMENT 'สถานะ',
  `created_at` date DEFAULT NULL COMMENT 'สร้างเมื่อ',
  `updated_at` date DEFAULT NULL COMMENT 'ปรับปรุงล่าสุดเมื่อ',
  `created_by` int(11) DEFAULT NULL COMMENT 'สร้างโดย',
  `updated_by` int(11) DEFAULT NULL COMMENT 'ปรับปรุงโดย',
  `request_by` int(11) DEFAULT NULL COMMENT 'จัดทำโดย',
  `category_id` int(11) DEFAULT NULL COMMENT 'ระดับเอกสาร',
  `department_id` int(11) DEFAULT NULL COMMENT 'แผนกที่รับผิดชอบ',
  `document_title` varchar(255) DEFAULT NULL COMMENT 'เรื่อง',
  `document_number` varchar(50) DEFAULT NULL COMMENT 'ชื่อเอกสาร',
  `document_details` text COMMENT 'รายละเอียดเอกสาร',
  ...
  `fullname` varchar(255) DEFAULT NULL COMMENT 'เลขที่เอกสาร',
  `covenant` varchar(255) DEFAULT NULL COMMENT 'PDF',
...
(13, '202307-012', 'ถั่วเหลือง Organic', '', 'ST.Lawrence Beans', '2019-11-28', 60, '2023-07-22 13:16:01', '2023-08-18 15:27:49', 3, 1, 1, 4, 2, 1, 2, 'ไม่มีการซื้อขายแล้ว', 'hH11yBt30BGkqY3dzmL2b0', '{\"d739cad180f87056c5867f323fdc6a24.pdf\":\"ถั่วเหลือง Organic - ST-Lawrence Beans.pdf\"}'),
...
(26, '202308-001', 'USDA Organic', 'DSDA Organic regulations, 7 CFR part 205 (NOP) และ Product list', 'PB Valley Chiangrai', '2023-07-31', 60, '2023-08-05 10:45:07', '2023-08-19 10:18:24', 3, 1, 1, 8, 1, 1, 3, '', 'MlAspZCEGfeZyCPa9GeY-k', '[]'),
...
(58, '202308-034', 'ISO 14001:2015', '', 'Right Solution', '2023-07-09', 60, '2023-08-16 09:50:34', '2023-08-19 09:28:58', 3, 1, 4, 8, 2, 2, 3, '', 'HVB-RMfrtHEx3Xm-KKD1X5', '{\"646d3fc0cd90fa2f293832c3f4737e4f.pdf\":\"ISO14001 CN09 30314.02 2023.07.09.pdf\"}'),
(59, '202308-035', 'ISO 45001:2018', '', 'Right Solution', '2023-07-09', 60, '2023-08-16 10:15:21', '2023-08-19 14:05:36', 3, 1, 3, 8, 2, 2, 3, 'รอใบรับรองจากผู้ขาย', 'p-aY2Pwj7NfL5RZ9W0lbyG', '{\"ff84b6379927d1561d95c011350dcfc4.pdf\":\"ISO45001 CN20 30094.02  2023.07.09.pdf\"}'),
(60, '202308-036', 'ISO 9001:2015', '', 'Right Solution', '2023-07-09', 60, '2023-08-16 10:18:14', '2023-08-19 14:22:25', 3, 1, 2, 8, 2, 2, 3, 'กำลังแก้ไข \r\nผู้รับผิดชอบ: นายทดสอบ โปรแกรม', 'nAg7BtuhogqG5UPgy8e8rO', '{\"3c85df2e9a7a04d481c1902f957882e1.pdf\":\"ISO9001 CN09 30355.02 2023.07.09.pdf\"}'),
...
(63, '202308-041', 'test', 'aaaa', 'aaaa', '2023-08-23', 60, '2023-08-21 08:30:13', NULL, 12, 12, 2, 2, 1, 2, 3, 'aaa', '4Dojg7VKj3J9_w22oHlYIv', '{\"900dd0218c3e1dc4cc0a42cfa1d90184.pdf\":\"HALAL ASSURANCE SYSTEM STATUS.pdf\"}'),
(64, '202308-042', 'asdasd', 'asdasd', 'asdasda', '2023-08-24', 60, '2023-08-21 14:25:43', '2023-08-22 10:05:15', 12, 12, 2, 2, 1, 2, 2, 'asdasd', '5nHhDtOLQ_SZ8O9pgveiRF', '{\"ca8a305201afba4f8a5e412bd520f97e.pdf\":\"grid-export.pdf\",\"bf7e0efb70683f94d437ab615815282f.pdf\":\"FM-GR-01_Rev_06[1].pdf\"}'),
(65, '202308-044', 'ssss', '', 'sssss', '2023-08-22', 60, '2023-08-22 12:05:51', '2023-08-22 12:08:34', 12, 12, 1, 5, 1, 5, 3, 'sss', 'kZ1bFaEDEQ__nl4NijiB6i', '{\"0ee0ac3d3490a534f621bf27bee7f5f7.pdf\":\"FSSC22000 EXP05JAN2025 (1).pdf\"}'),
(66, '202308-045', 'asdas', 'asdas', 'sadasdasd', '2023-08-23', 60, '2023-08-23 15:10:04', NULL, 1, 1, 1, 5, 1, 5, 1, 'asdasd', 'WQkUljkJz5bux2WeT9dygz', '{\"9798937501423b0a51ffcba52b6b765d.pdf\":\"ข้าวหอมมะลิอินทรีย์ - กฤษณกรณ์.pdf\",\"506f09ce804a20da31415e7e6fdf9b58.pdf\":\"ถั่วเหลือง Organic FT. - อุ่มแสง.pdf\"}'),
(67, '202308-046', 'Organic Products', 'Organic Products', 'Organic Products', '2023-07-31', 60, '2023-08-23 15:11:03', '2023-08-23 15:11:11', 1, 1, 2, 5, 1, 3, 1, '', 'wQQ9YtltbK91KE62XMJFxh', '{\"bbbb220b1ab256faab96759adb475b88.pdf\":\"ISO9001 CN09 30355.02 2023.07.09.pdf\"}');
...
CREATE TABLE `employees` (
  ...
  `th_fname` varchar(100) DEFAULT NULL,
  `th_lname` varchar(100) DEFAULT NULL,
  `en_fname` varchar(100) DEFAULT NULL,
  `en_lname` varchar(100) DEFAULT NULL,
...
INSERT INTO `iso` (`id`, `name`, `files`, `exp`, `product_spec_id`) VALUES
(1, 'GHPs', NULL, NULL, NULL),
(2, 'Haccp', NULL, NULL, NULL),
(3, 'ISO9001', NULL, NULL, NULL),
(4, 'ISO45001', NULL, NULL, NULL),
(5, 'ISO14001', NULL, NULL, NULL),
(6, 'FSSC22000', NULL, NULL, NULL),
(7, 'BRC', NULL, NULL, NULL),
(8, 'Organic', NULL, NULL, NULL),
(9, 'Halal', NULL, NULL, NULL),
(10, 'Kosher', NULL, NULL, NULL),
(11, 'Fairtrade', NULL, NULL, NULL);
...
INSERT INTO `items` (`id`, `code`, `name`, `files`, `exp_date`) VALUES
(1, 'nfc-001', 'item 1', 'file 1', '2023-08-21'),
(2, 'nfc-002', 'item 2', 'file 2', '2023-08-25');
...
CREATE TABLE `ncr` (
  ...
  `ncr_number` varchar(255) DEFAULT NULL COMMENT 'เลขที่ NCR',
  ...
  `customer_name` varchar(200) DEFAULT NULL COMMENT 'ชื่อลูกค้า',
  ...
  `to_department` text COMMENT 'ถึงหน่วยงาน',
  `problem` text COMMENT 'กระบวนการที่พบปัญหา',
...
INSERT INTO `ncr` (`id`, `ref`, `ncr_number`, `detail`, `start_date`, `end_date`, `location`, `customer_name`, `customer_mobile_phone`, `province_id`, `from_department`, `to_department`, `problem`, `lot`, `production_date`, `product_name`, `notify_by`, `proplem_date`, `recheck`, `created_at`, `updated_at`, `status`) VALUES
(5, '9XD5TDj7HWVok2ArzrXAHA', 'NCR-2308/01', 'Light Color 1 kL. Lot 272/23 Mfd. 22/08/2023 จำนวน 10 ถัง จะส่งออกก่อนผลเชื้อ TPC, YM ออก', NULL, NULL, NULL, 'QP', NULL, NULL, '1', '2,5', '3,5', '272/23', '2023-08-22', 'Light Color 1 kL', 'อรอนงค์', '2023-08-22', '', 1692610894, 1692760405, 1),
(6, 'iJfLemE5eIZSGoQMUFcuSm', 'NCR-2308/02', 'Organic FT. Original 200 ml.  Lot no. 271/23  Mfd. 21/08/2023 ส่งออกก่อนผลเชื้อ YM ออก', NULL, NULL, NULL, '', NULL, NULL, '1', '2,5', '3,5', '271/23', '2023-08-21', 'Organic FT. Original 200 ml.', 'อรอนงค์', '2023-08-23', '', 1692758210, 1692760383, 2),
(7, 'IaxVvNg2XfLJ4WB2jX5g1Q', 'NCR-2308/03', 'Rich 18 L  Lot no. 270/23  Mfd. 19/08/2023 ส่งออกก่อนผลเชื้อ YM ออก', NULL, NULL, NULL, '', NULL, NULL, '1', '2,5', '3,5', '270/23', '2023-08-19', 'Rich 18 L', 'อรอนงค์', '2023-08-23', '', 1692758290, 1692760361, 3);
...
(1, 'New', 'แจ้ง', '#DF2E38'),
(2, 'In Progress', 'ดำเนินการ', '#EF9A53'),
...
CREATE TABLE `product_spec` (
  ...
  `iso` varchar(200) DEFAULT NULL COMMENT 'ใบรับรอง',
  `created_at` varchar(50) DEFAULT NULL,
  `updated_at` varchar(50) DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `product_status` int(11) DEFAULT NULL COMMENT 'สถานะ',
...
INSERT INTO `product_spec` (`id`, `product_number`, `revision`, `revised_date`, `title`, `description`, `spec`, `spec_expiration`, `process`, `process_expiration`, `fda`, `fda_expiration`, `nutrition`, `nutrition_expiration`, `iso`, `created_at`, `updated_at`, `created_by`, `updated_by`, `product_status`, `ref`) VALUES
(4, 'P202308-062', '1', '2023-08-23', 'ORGANIC SPRING ROLL SAUCE FOR INDUSTRAIL', '', '{\"732ffe8bbf37e4a9405017dd34138409.pdf\":\"Document (1).pdf\",\"cc91947789fc4ca31c78c699756b7294.pdf\":\"NT_พร้อมตาราง.pdf\"}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1,6', '1692783146', '1692783146', 1, 1, 1, 'SdHsnxxRfpOu4cvM_Ppvps');
...
(36, 'IaxVvNg2XfLJ4WB2jX5g1Q', 'IMG_7411.jpg', '2a7d7af37b2345a1cf8137f6ed0bcdf1.jpg', '2023-08-23 03:12:40', NULL),
(37, 'IaxVvNg2XfLJ4WB2jX5g1Q', 'IMG_7423.jpg', 'b709067ee1ad982afa496e709b0f95eb.jpg', '2023-08-23 03:12:41', NULL),
(38, 'iJfLemE5eIZSGoQMUFcuSm', 'IMG_7486.jpg', 'bdf8677589b337dd3b46c3eac8feb268.jpg', '2023-08-23 03:13:02', NULL),
(39, 'iJfLemE5eIZSGoQMUFcuSm', 'IMG_7481.jpg', '5da1c24fee447cc445c592e6f5b5c24e.jpg', '2023-08-23 03:13:03', NULL),
(40, '9XD5TDj7HWVok2ArzrXAHA', '358116134_777253240764863_7744795619755399537_n.jpg', '7b9b0da793e6fe18add47b5a86dc927a.jpg', '2023-08-23 03:13:25', NULL),
(41, '9XD5TDj7HWVok2ArzrXAHA', 'IMG_7546.jpg', '8df4b8fb3c309bb93278b57dcb1eac42.jpg', '2023-08-23 03:13:25', NULL);
...
ALTER TABLE `product_items`
  ADD PRIMARY KEY (`products_id`,`items_id`),
  ADD KEY `fk_products_has_items_items1_idx` (`items_id`),
  ADD KEY `fk_products_has_items_products1_idx` (`products_id`);
...
--
-- AUTO_INCREMENT for table `dc_requests`
--
ALTER TABLE `dc_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `product_items`
  ADD CONSTRAINT `fk_products_has_items_items1` FOREIGN KEY (`items_id`) REFERENCES `items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_products_has_items_products1` FOREIGN KEY (`products_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
