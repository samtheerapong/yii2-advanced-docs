                            ...
                            <?php foreach ($documents as $document) : ?>
                                <tr>
                                    ...
                                    <td class="text-center skip-export kv-align-center kv-align-middle w4" style="width:100px;" data-col-seq="9">
                                        <div class="btn-group btn-group-xs" role="group"> <a class="btn btn-outline-dark btn-sm" href="/backend/web/documents/15" title="ดู" aria-label="ดู" data-pjax="0"><span class="fas fa-eye" aria-hidden="true"></span></a> <a class="btn btn-outline-dark btn-sm" href="/backend/web/documents/update/15" title="ปรับปรุง" aria-label="ปรับปรุง" data-pjax="0"><span class="fas fa-pencil-alt" aria-hidden="true"></span></a></div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
